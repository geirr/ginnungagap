...
#ifndef NIFLHEIM_AVATARSVIEW_H
#define NIFLHEIM_AVATARSVIEW_H
...
namespace niflheim
{
	struct AvatarsView
	{
		std::pair<int, int> visibleTopLeftCorner;
		std::pair<int, int> visibleLowerRightCorner;
		std::vector<WorldObjectInfo> worldObjects;
	};
}
